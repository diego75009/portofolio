...
export default function Projects() {
  return (
    <section id="work" className="py-24 md:py-32 px-8 md:px-16 lg:px-24">
      {/* Section header */}
            ...
            >
              <div className="p-8 md:p-10 flex flex-col gap-4 h-full min-h-[280px]">
                ...
                {project.link && (
                  <a
                    href={project.link}
                    className="inline-flex items-center gap-2 text-accent font-display text-sm font-[700] tracking-wider uppercase mt-2 group"
                    target="_blank"
